...
- [ ] [Qtalr extras](): A GitHub repository with additional resources to add to R computing environments: Git setup, R packages, RStudio preferences, etc. (coming soon).
