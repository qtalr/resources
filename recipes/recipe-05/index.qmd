...
If you are interested in learning about another data collection strategy, web scraping, I suggest you look at the [Web scraping with R](guides/guide-07/) guide.
:::
...
From this overview, we can see that there are `r format(nrow(gutenbergr::gutenberg_metadata), big.mark = ",")` works in the Project Gutenberg database. We can also see that there are `r format(nrow(gutenbergr::gutenberg_authors), big.mark = ",")` authors and `r format(nrow(gutenbergr::gutenberg_subjects), big.mark = ",")` subjects.
